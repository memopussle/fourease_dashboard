...
const Dashboard = () => {
  const titleArray = [{ title: "Energy", data: 8, comparison: 10 }, { title: "Emotion", data: 10, comparison: -20 }, { title: "Productivity", data: 90, comparison: -10}, { title: "Well-being", data: 80 , comparison: 3}];
